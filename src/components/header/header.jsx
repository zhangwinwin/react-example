  ...
  render () {
    return (
      <header className="header-container">
        <span className="header-stle-icon" onClick={this.toggleNav}></span>
        ...
        <ReactCSSTransitionGroup
          ...
          {
            this.state.navState && <aside
            key="nav-slide"
            className="nav-slide-list" onClick={this.toggleNav}>
              <NavLink to="/" exact className="nav-link icon-jia"></NavLink>
